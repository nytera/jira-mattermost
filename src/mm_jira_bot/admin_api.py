...
def _ticket_to_dict(ticket: AlertTicket, *, full: bool = False) -> dict:
    ...
    data = {
        ...
        "alert_signature": ticket.alert_signature,
        "root_post_id": ticket.root_post_id,
        "is_root": ticket.root_post_id is None,
        "expected_repeat_linked": ticket.expected_repeat_linked,
